...
| **Login**          | 5 per minute      |                                         |
| **OAuth callback** | 10 per hour       | Instagram connect flow                  |
| **Webhook**        | 100 per minute    | Meta Instagram webhook                  |
| **Default (global)** | 200 per day, 50 per hour | Applies when no route-specific limit |
